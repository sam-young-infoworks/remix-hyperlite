...
export const StripeButton: React.FC<{ paying?: boolean; onClick?: () => Promise<void> | void }> = ({
    ...
    return (
        <button
            ...
            className="w-full text-white mt-2 h-[70px] rounded-md px-8 bg-gray-100 flex flex-row justify-between items-center border border-transparent hover:border-black"
        >
