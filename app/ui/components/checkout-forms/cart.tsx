    ...
    <div className="lg:w-2/5 w-full">
        ...
        {cart &&
          cart.items.map((item: any, index: number) => {
            ...
            return (
              ...
              <div
                key={index}
                className="mt-2 min-h-[60px] rounded-md flex justify-between bg-gray-100 p-2 items-center"
              >
      ...
      {total && (
        <div className="flex flex-col gap-1  py-4 items-end">
          <div className="flex text-gray-700 text-sm justify-between w-60">
            <p>Discount</p>
            <p>
