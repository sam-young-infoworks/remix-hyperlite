...
export const MagicLoginForm: React.FC<{
  ...
  const vippsLoginUrl = `https://${appContextState.paymentImplementationVariables?.vipps?.ORIGIN || 'api.vipps.no'
  ...
  return (
    <div className="flex flex-col mt-5 gap-2 w-full sm:min-w-[400px]">
      ...
      <h1 className="font-bold text-2xl">
        {title.replace('Register', isAuthenticated ? 'login' : 'register')}
      </h1>
      <p className="mb-5 text-lg">will Send You Magick Link</p>
      <form
